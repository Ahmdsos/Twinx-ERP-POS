    ...
    <div class="container-fluid p-0">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-5 gap-4">
            <div class="d-flex align-items-center gap-4">
                <a href="{{ route('products.index') }}" class="btn btn-icon-glass shadow-none border-white-5">
                    <i class="bi bi-arrow-right fs-4"></i>
                </a>
                <div class="d-flex flex-column">
                    <div class="d-flex align-items-center gap-3">
                        <h2 class="fw-bold text-white mb-0 tracking-wide">{{ $product->name }}</h2>
                        @if($product->is_active)
                            <span
                                class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-20">نشط</span>
                        @else
                            <span
                                class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-20">معطل</span>
                        @endif
                    </div>
                    <div class="d-flex align-items-center gap-3 mt-1 text-gray-400 font-monospace small">
            ...
            <div class="d-flex gap-3">
                ...
                <a href="{{ route('stock.adjust') }}?product_id={{ $product->id }}"
                    ...
                    <i class="bi bi-sliders"></i> تسوية مخزون
                </a>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="glass-panel p-4 position-relative overflow-hidden h-100">
                            ...
                            <h6 class="text-gray-400 text-uppercase small fw-bold mb-2">سعر البيع</h6>
                            <h3 class="text-success fw-bold mb-0">{{ number_format($product->selling_price, 2) }} <small
                                    class="fs-6 text-white text-opacity-50">EGP</small></h3>
                        </div>
                    </div>
                    <!-- Cost Price -->
                    <div class="col-md-4">
                        <div class="glass-panel p-4 position-relative overflow-hidden h-100">
                            ...
                            <h6 class="text-gray-400 text-uppercase small fw-bold mb-2">سعر التكلفة</h6>
                            <h3 class="text-white fw-bold mb-0">{{ number_format($product->cost_price, 2) }} <small
                                    class="fs-6 text-white text-opacity-50">EGP</small></h3>
                        </div>
                    </div>
                    <!-- Total Stock -->
                    <div class="col-md-4">
                        <div class="glass-panel p-4 position-relative overflow-hidden h-100 border-top-gradient-purple">
                            ...
                            <h6 class="text-gray-400 text-uppercase small fw-bold mb-2">إجمالي المخزون</h6>
                            <h3 class="text-cyan-400 fw-bold mb-0">{{ number_format($product->total_stock, 2) }} <small
                                    class="fs-6 text-gray-400">{{ $product->unit->name }}</small></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-panel p-4">
                    <ul class="nav nav-pills custom-pills mb-4 pb-3 border-bottom border-white-5" id="pills-tab"
                        role="tablist">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="pills-info">
                            <div class="row g-4">
                                <div class="col-md-4">
                                    <div class="bg-slate-900 bg-opacity-30 rounded-3 p-3 border border-white-5">
                                        <span class="d-block text-gray-500 x-small text-uppercase mb-1">الباركود</span>
                                        <div class="d-flex align-items-center gap-2">
                                            <i class="bi bi-upc-scan text-purple-400"></i>
                                            <span class="text-white font-monospace">{{ $product->barcode ?? 'N/A' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="bg-slate-900 bg-opacity-30 rounded-3 p-3 border border-white-5">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span
                                                class="text-white fw-bold">{{ $product->brand->name ?? 'غير محدد' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="bg-slate-900 bg-opacity-30 rounded-3 p-3 border border-white-5">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span class="text-white">{{ $product->category->name ?? 'غير مصنف' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="bg-slate-900 bg-opacity-30 rounded-3 p-3 border border-white-5">
                                        <span class="d-block text-gray-500 x-small text-uppercase mb-2">الوصف</span>
                                ...
                                <!-- Attributes -->
                                <div class="col-12">
                                    <h6 class="text-white fw-bold mb-3 mt-2">المواصفات الفنية</h6>
                                    <div class="table-responsive">
                                        <table class="table table-dark-custom table-sm mb-0">
                                            <tbody>
                                                <tr>
                                                    <td class="text-gray-500 w-25">العلامة التجارية</td>
                                                    <td class="text-white">{{ $product->brand->name ?? '-' }}</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <span class="text-white fw-bold">{{ $stock->warehouse->name }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <span
                                                ...
                                                <td class="text-gray-400 font-monospace">
                        ...
                        <div class="tab-pane fade" id="pills-movements">
                            <div class="text-center py-4">
                                ...
                                <p class="text-gray-400">لمشاهدة سجل الحركات التفصيلي، انتقل إلى قسم الحركات.</p>
            ...
            <div class="col-lg-4">
                ...
                <div class="glass-panel p-2 mb-4 text-center">
                    <div class="rounded-3 overflow-hidden position-relative" style="height: 300px;">
                        ...
                        @else
                            <div
                                class="w-100 h-100 bg-slate-900 d-flex flex-column align-items-center justify-content-center text-gray-600">
                ...
                <!-- Settings Summary -->
                <div class="glass-panel p-4">
                    <h6 class="text-white fw-bold mb-3 border-bottom border-white-5 pb-2">الإعدادات</h6>
                    <div class="d-flex flex-column gap-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-gray-400 small">قابل للبيع</span>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-gray-400 small">قابل للشراء</span>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-gray-400 small">السعر شامل الضريبة</span>
                            @if($product->is_tax_inclusive)
                                <span class="badge bg-purple-500 bg-opacity-20 text-purple-300">نعم</span>
                            @else
                                <span class="badge bg-gray-700 text-gray-400">لا (+{{ $product->tax_rate }}%)</span>
                            @endif
                        </div>
                    </div>
                </div>
