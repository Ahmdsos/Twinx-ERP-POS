...
@section('title', 'تقرير أعمار ديون الموردين')
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0">تقرير أعمار ديون الموردين</h1>
                <p class="text-muted mb-0">AP Aging Report</p>
            </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="card border-0 bg-dark text-white">
                    <div class="card-body text-center">
                        <div class="text-uppercase small">إجمالي المستحق</div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-light">
                <h6 class="mb-0">تفصيل الديون حسب المورد</h6>
            </div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        @forelse($agingData as $row)
                            <tr>
                                <td><code>{{ $row['supplier_code'] }}</code></td>
                                <td>
