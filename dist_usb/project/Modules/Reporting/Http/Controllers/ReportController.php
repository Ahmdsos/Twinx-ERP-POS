...
class ReportController extends Controller
{
    ...
    public function inventory(Request $request)
    {
        ...
        $modernData = $this->stockReportService->stockValuation($warehouseId ? (int) $warehouseId : null);
        ...
        return view('reports.inventory.valuation', compact('stockValue', 'totalCostValue', 'totalRetailValue', 'warehouses', 'selectedWarehouse'));
    }
    ...
    {
        $query = \Modules\Sales\Models\PosShift::with('user')->latest('opened_at');
