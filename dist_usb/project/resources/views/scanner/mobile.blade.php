...
<body>
    ...
    <div class="scanner-container">
        ...
        <div class="product-card" id="productCard">
            ...
            <div class="product-grid">
                ...
                <!-- Cost Price -->
                <div class="product-field">
                    <div class="field-label">سعر التكلفة</div>
                    <div class="field-value" id="pCost"></div>
                </div>
            ...
            <!-- Toggle Prices -->
            <button class="btn-toggle-prices" onclick="togglePrices()">
                عرض جميع الأسعار ▼
            </button>
            ...
            <div class="prices-section" id="pricesSection">
                <div class="prices-grid">
                    <div class="price-item">
                        <div class="price-item-label">موزعين</div>
                        <div class="price-item-value" id="pPriceDistributor">-</div>
                    </div>
                    <div class="price-item">
                        <div class="price-item-label">جملة</div>
                        <div class="price-item-value" id="pPriceWholesale">-</div>
                    </div>
                    <div class="price-item">
                        <div class="price-item-label">نص جملة</div>
                        <div class="price-item-value" id="pPriceHalfWholesale">-</div>
                    </div>
                    <div class="price-item">
                        <div class="price-item-label">ربع جملة</div>
                        <div class="price-item-value" id="pPriceQuarterWholesale">-</div>
                    </div>
                    <div class="price-item">
                        <div class="price-item-label">خاص</div>
                        <div class="price-item-value" id="pPriceSpecial">-</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function displayProduct(p) {
            ...
            document.getElementById('pCost').textContent = formatNumber(p.cost_price) + ' EGP';
            ...
            // Pricing tiers
            setPrice('pPriceDistributor', p.price_distributor);
            setPrice('pPriceWholesale', p.price_wholesale);
            setPrice('pPriceHalfWholesale', p.price_half_wholesale);
            setPrice('pPriceQuarterWholesale', p.price_quarter_wholesale);
            setPrice('pPriceSpecial', p.price_special);

            show('productCard');
        }

        function setPrice(id, val) {
            document.getElementById(id).textContent = (val && parseFloat(val) > 0) ? formatNumber(val) : '-';
        }
        ...
        function togglePrices() {
            const section = document.getElementById('pricesSection');
