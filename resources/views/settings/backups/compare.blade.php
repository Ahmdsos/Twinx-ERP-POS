                ...
                <div class="glass-card h-100 p-0 overflow-hidden border border-warning border-opacity-50 shadow-lg"
                    ...
                    <div class="p-5">
                            ...
                            <div class="col-6">
                                ...
                                @if($backupStats['size'] > $liveStats['size'])
                                    <div class="badge bg-success bg-opacity-25 text-success mt-2">
                                        ...
                                        {{ \App\Http\Controllers\BackupController::formatBytes($backupStats['size'] - $liveStats['size']) }}
                                    </div>
                                @elseif($backupStats['size'] < $liveStats['size'])
                                    <div class="badge bg-danger bg-opacity-25 text-danger mt-2">
                                        ...
                                        {{ \App\Http\Controllers\BackupController::formatBytes($liveStats['size'] - $backupStats['size']) }}
                                    </div>
                                @else
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-end">
                                <div class="text-white fw-bold font-monospace mb-0">
                                    {{ date('Y-m-d H:i', $backupStats['date']) }}</div>
                                <small
