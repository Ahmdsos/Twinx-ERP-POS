    ...
    <div class="container-fluid p-0">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-5 gap-4">
            ...
            <div class="d-flex gap-2">
                <a href="{{ asset('inventory_guide.html') }}" target="_blank"
                    ...
                    <form action="{{ route('products.import') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control" type="file" id="importFile" name="file" required
        ...
        <div class="bg-surface bg-opacity-50 border border-secondary border-opacity-10-5 rounded-4 p-4 mb-5">
            <form action="{{ route('products.index') }}" method="GET" class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="category_id" class="form-select form-select text-body cursor-pointer hover:bg-surface-5">
                ...
                <div class="col-md-3">
                    ...
                    <select name="brand_id" class="form-select form-select text-body cursor-pointer hover:bg-surface-5">
                        <option value="">-- الكل --</option>
                ...
                <div class="col-md-2">
                    ...
                    <select name="stock_status" class="form-select form-select text-body cursor-pointer hover:bg-surface-5">
                        <option value="">-- الكل --</option>
                ...
                <div class="col-md-1">
                    ...
                    <select name="sort_dir" class="form-select form-select text-body cursor-pointer hover:bg-surface-5">
