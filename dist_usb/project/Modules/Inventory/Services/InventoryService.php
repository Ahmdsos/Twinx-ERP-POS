...
class InventoryService
{
    ...
    public function addStock(
        ...
        return DB::transaction(function () use ($product, $warehouse, $quantity, $unitCost, $type, $reference, $notes, $sourceType, $sourceId, $createJournal) {
            // CRITICAL: Fall back to product cost_price if unitCost is zero
    ...
    public function adjust(
        ...
        // Fall back to product cost_price if average_cost is also zero
        $unitCost = $newUnitCost ?? ($stock->average_cost > 0 ? $stock->average_cost : $product->cost_price);
