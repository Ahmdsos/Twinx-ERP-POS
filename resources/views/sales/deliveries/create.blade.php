...
@section('content')
    <div class="container-fluid p-0">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold text-white mb-0">إنشاء إذن صرف</h2>
        ...
        <div class="row g-4" x-data="deliveryForm()">
                ...
                <div class="glass-panel p-4 rounded-4 border border-white/10 shadow-lg">
                    <form action="{{ route('deliveries.store') }}" method="POST" id="delivery-form">
                        ...
                        @if(isset($salesOrder))
                            ...
                            <div
                                class="d-flex align-items-center justify-content-between bg-white/5 p-3 rounded mb-4 border border-white/10">
                                <div>
                                    <label class="text-gray-500 small d-block">أمر البيع</label>
                                    <span class="fw-bold text-white fs-5">{{ $salesOrder->so_number }}</span>
                                </div>
                                <div>
                                    <label class="text-gray-500 small d-block">العميل</label>
                                    <span class="fw-bold text-white">{{ $salesOrder->customer->name }}</span>
                                </div>
                                <div>
                                    <label class="text-gray-500 small d-block">التاريخ</label>
                                    <span class="text-white">{{ $salesOrder->order_date->format('Y-m-d') }}</span>
                                </div>
                            </div>
                        @else
                            <div class="mb-4">
                        ...
                        @if(isset($salesOrder))
                            <div class="mb-4">
                                <h5 class="text-white fw-bold mb-3 border-bottom border-white/10 pb-2">المنتجات المطلوب صرفها
                                </h5>
                                <div class="table-responsive">
                                    <table class="table table-borderless align-middle mb-0">
                                        <thead class="bg-white/5 text-gray-400 small">
                                            <tr>
                                                <th class="ps-3 py-2 rounded-start">المنتج</th>
                                                ...
                                                @if($remaining > 0)
                                                    <tr class="border-bottom border-white/5">
                                                        ...
                                                        <td class="text-center"><span
                                                                class="badge bg-white/10">{{ $line->quantity + 0 }}</span></td>
                                                        <td class="text-center"><span
                        ...
                        <div class="row g-3 mb-4 border-top border-white/10 pt-4">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label class="form-label text-gray-300">العنوان</label>
                            ...
                            <div class="col-12">
                                <label class="form-label text-gray-300">ملاحظات</label>
                                <textarea name="notes" class="form-control glass-input" rows="3"></textarea>
                            </div>
                        </div>

                        <div class="d-flex justify-content-end gap-2">
                            <button type="button" class="btn btn-glass-outline px-4">إلغاء</button>
            ...
            <div class="col-lg-4">
                <div class="glass-panel p-4 rounded-4 border border-white/10 shadow-lg">
                    <h5 class="fw-bold text-white mb-4"><i class="bi bi-info-circle me-2 text-info"></i> تعليمات</h5>
