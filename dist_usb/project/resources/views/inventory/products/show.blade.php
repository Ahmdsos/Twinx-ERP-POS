        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-5 gap-4">
            <div class="d-flex align-items-center gap-4">
                <a href="{{ route('products.index') }}"
                    class="btn btn-icon-glass shadow-none border-secondary border-opacity-10-5">
            ...
            <div class="d-flex gap-3">
                ...
                <a href="{{ route('barcode.print', $product->id) }}?no_price=1" target="_blank"
                    class="btn btn-outline-purple d-flex align-items-center gap-2">
                    <i class="bi bi-upc-scan"></i> طباعة (بدون سعر)
                </a>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="glass-panel p-4">
                    <ul class="nav nav-pills custom-pills mb-4 pb-3 border-bottom border-secondary border-opacity-10-5"
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="pills-info">
                            <div class="row g-4">
                                <div class="col-md-4">
                                    <div
                                        class="bg-surface bg-opacity-30 rounded-3 p-3 border border-secondary border-opacity-10-5">
                                        <span
                                            class="d-block text-gray-500 x-small text-uppercase mb-1">{{ __('Barcode') }}</span>
                                ...
                                <div class="col-md-4">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span class="text-body fw-bold">{{ $product->brand->name ?? 'غير محدد' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-12">
                                    <div
                                        class="bg-surface bg-opacity-30 rounded-3 p-3 border border-secondary border-opacity-10-5">
                                        <span
                                            class="d-block text-gray-500 x-small text-uppercase mb-2">{{ __('Description') }}</span>
            ...
            <div class="col-lg-4">
                ...
                <!-- Settings Summary -->
                <div class="glass-panel p-4">
                    <h6 class="text-heading fw-bold mb-3 border-bottom border-secondary border-opacity-10-5 pb-2">
                        {{ __('Settings') }}</h6>
