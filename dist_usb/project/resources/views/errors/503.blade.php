...
<head>
    ...
    <title>503 - تحت الصيانة | Twinx ERP</title>
    <!-- Bootstrap 5.3 RTL -->
...
<body>
    ...
    <div class="error-container">
        ...
        <h1 class="error-title">النظام تحت الصيانة</h1>
        <p class="error-message">
            نحن نقوم ببعض التحسينات الآن لتقديم أفضل خدمة ممكنة. سنعود للعمل قريباً جداً، شكراً لصبركم.
        </p>
        <a href="{{ url('/') }}" class="btn-home">
            <i class="bi bi-arrow-repeat me-2"></i> المحاولة لاحقاً
        </a>
    </div>
</body>
</html>