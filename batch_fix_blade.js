...
// Sort by length descending to replace longest phrases first (avoids partial matches)
...
const cssSubs = [
    ...
    // Context-specific table headers (matches standard pattern in these files)
...
function processFile(filePath) {
    ...
    for (const { arabic, english } of substitutions) {
        ...
        // Captures the first part of the section directive to preserve it
