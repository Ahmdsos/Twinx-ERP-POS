    ...
    <div class="container-fluid p-0">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold text-heading mb-0">{{ __('Account Statement') }}</h3>
            ...
            <div class="d-flex gap-2">
                ...
                <div class="bg-slate-800 rounded px-3 py-1 border border-slate-700">
                    <small class="text-gray-400 d-block">{{ __('Current Balance') }}</small>
                    <span class="fw-bold fs-5 {{ $balance > 0 ? 'text-danger' : ($balance < 0 ? 'text-success' : 'text-body') }}">
        ...
        <!-- Filters -->
        <div class="bg-slate-900 bg-opacity-50 border border-secondary border-opacity-10-5 rounded-4 p-4 mb-4 dont-print">
            <form action="{{ route('customers.statement', $customer->id) }}" method="GET" class="row g-3">
                ...
                <div class="col-md-4 d-flex align-items-end">
                    <button type="submit" class="btn btn-primary w-100">
                        <i class="bi bi-filter"></i>{{ __('View') }}</button>
                </div>
            </form>
        </div>
                    ...
                    <table class="table table-dark table-hover mb-0">
                        <thead class="bg-slate-800">
                            <tr>
                                ...
                                <th class="p-3 text-end">{{ __('Balance') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            <!-- Opening Balance -->
                                ...
                                <tr>
                                    ...
                                    <td class="p-3">
                                        @if($trans->type == 'invoice')
                                            <span class="badge bg-purple-500 bg-opacity-20 text-purple-300">{{ __('Sales Invoice') }}</span>
