...
<head>
    ...
    <title>403 - وصول غير مصرح | Twinx ERP</title>
    <!-- Bootstrap 5.3 RTL -->
    ...
    <style>
        ...
        .btn-home {
            background: linear-gradient(135deg, #ffc107 0%, #e0a106 100%);
            border: none;
...
<body>
    ...
    <div class="error-container">
        ...
        <p class="error-message">
            ليس لديك الأذونات الكافية للوصول إلى هذه الصفحة. إذا كنت تعتقد أن هذا خطأ، يرجى التواصل مع المسؤول.
        </p>
