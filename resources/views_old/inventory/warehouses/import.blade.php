...
@section('title', 'استيراد المستودعات - Twinx ERP')
@section('page-title', 'استيراد المستودعات من CSV')
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="bi bi-upload me-2"></i>استيراد المستودعات من ملف CSV</h5>
                </div>
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <ul class="mb-0">
                            ...
                            <li>الأعمدة الاختيارية: address, phone, email</li>
                            <li>إذا كان الكود موجود، سيتم تحديث المستودع</li>
                        </ul>
                    </div>

                    <div class="mb-4">
                        <a href="{{ route('warehouses.import.sample') }}" class="btn btn-outline-primary">
