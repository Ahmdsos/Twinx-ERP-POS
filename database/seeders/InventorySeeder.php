...
class InventorySeeder extends Seeder
{
    ...
    protected function createCategories(): void
    {
        ...
        $office = Category::create(['name' => 'Office Supplies', 'sort_order' => 2]);
        $consumables = Category::create(['name' => 'Consumables', 'sort_order' => 3]);

        // Electronics subcategories
        Category::create(['name' => 'Computers', 'parent_id' => $electronics->id, 'sort_order' => 1]);
        Category::create(['name' => 'Phones', 'parent_id' => $electronics->id, 'sort_order' => 2]);
        Category::create(['name' => 'Accessories', 'parent_id' => $electronics->id, 'sort_order' => 3]);

        // Office subcategories
        Category::create(['name' => 'Paper Products', 'parent_id' => $office->id, 'sort_order' => 1]);
        Category::create(['name' => 'Writing Tools', 'parent_id' => $office->id, 'sort_order' => 2]);
        Category::create(['name' => 'Furniture', 'parent_id' => $office->id, 'sort_order' => 3]);
    }
