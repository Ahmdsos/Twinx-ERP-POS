...
@section('title', 'تعديل قيد - ' . $journalEntry->entry_number)
...
@section('content')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="d-flex align-items-center mb-4">
                    <a href="{{ route('journal-entries.show', $journalEntry) }}" class="btn btn-outline-secondary me-3">
                        <i class="bi bi-arrow-right"></i>
                    </a>
                    <div>
                        <h1 class="h3 mb-0">تعديل قيد اليومية</h1>
                ...
                <form action="{{ route('journal-entries.update', $journalEntry) }}" method="POST" id="journalForm">
                    ...
                    <div class="d-flex justify-content-between">
                        <form action="{{ route('journal-entries.destroy', $journalEntry) }}" method="POST"
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('journal-entries.show', $journalEntry) }}" class="btn btn-secondary">إلغاء</a>
    ...
    <script>
        ...
        const existingLines = @json($journalEntry->lines);
        let lineIndex = 0;
        ...
        document.addEventListener('DOMContentLoaded', function () {
            existingLines.forEach(line => {
                addLine(line.account_id, line.debit || '', line.credit || '', line.description || '');
            });

            // Ensure at least 2 lines
            if (existingLines.length < 2) {
                for (let i = existingLines.length; i < 2; i++) {
                    addLine();
                }
            }
        });
