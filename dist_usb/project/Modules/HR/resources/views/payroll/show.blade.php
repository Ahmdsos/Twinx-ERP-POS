...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-3">
                <div
                    class="glass-card p-4 rounded-4 border-secondary border-opacity-10 border-opacity-10 text-center bg-surface-secondary bg-opacity-25">
        ...
        <!-- Details Table -->
        <div
            class="glass-card rounded-4 border-secondary border-opacity-10 border-opacity-10 overflow-hidden shadow-lg bg-surface-secondary bg-opacity-25">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 text-heading text-start">
                    <thead>
                        <tr
                            class="bg-white bg-opacity-5 border-bottom border-secondary border-opacity-10 border-opacity-10">
    ...
    <div class="modal fade" id="editItemModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div
                class="modal-content glass-card border-secondary border-opacity-10 border-opacity-10 rounded-4 shadow-lg bg-surface-secondary">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            editButtons.forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    form.action = `{{ url('/hr/payroll/items') }}/${id}`;
                });
            });
        });
    </script>
