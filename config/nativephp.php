...
return [
    ...
    'app_id' => env('NATIVEPHP_APP_ID', 'com.twinx.erp'),

    'deeplink_scheme' => env('NATIVEPHP_DEEPLINK_SCHEME', 'twinx'),

    'author' => env('NATIVEPHP_APP_AUTHOR', 'Twinx Systems'),

    'copyright' => env('NATIVEPHP_APP_COPYRIGHT', 'Twinx Systems 2026'),

    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Twinx ERP - Advanced Business Management System'),
