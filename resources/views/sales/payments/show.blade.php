    ...
    <div class="container p-0" style="max-width: 800px;">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h2 class="fw-bold text-heading mb-0">تفاصيل التحصيل</h2>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('customer-payments.print', $customerPayment->id) }}" target="_blank"
                    class="btn btn-dark border-start border-secondary border-opacity-10/10 text-info hover-bg-info-dark rounded-pill px-4">
                    <i class="bi bi-printer me-2"></i>{{ __('Print Receipt') }}</a>
            </div>
        </div>
        ...
        <div class="glass-panel p-0 overflow-hidden position-relative">
            ...
            <div class="bg-surface/5 p-4 border-bottom border-secondary border-opacity-10/10 d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-3">
                    <div
                    ...
                    <span
                        class="fs-4 font-monospace fw-bold text-body tracking-wide">{{ $customerPayment->payment_number }}</span>
                </div>
            ...
            <div class="p-5">
                <div class="row g-5">
                    <div class="col-md-6 border-end border-secondary border-opacity-10/10">
                        <label class="section-label mb-3 text-success">بيانات العميل</label>
                        <div class="d-flex align-items-center gap-3 mb-4">
                            <div class="avatar-md bg-gradient-to-br from-gray-700 to-gray-800 rounded-circle text-white d-flex align-items-center justify-content-center border border-secondary border-opacity-10/10 shadow-sm"
                                style="width: 50px; height: 50px;">
                                <span class="fs-5 fw-bold">{{ substr($customerPayment->customer->name, 0, 1) }}</span>
                            </div>
                            <div>
                                <h5 class="text-heading fw-bold mb-0">{{ $customerPayment->customer->name }}</h5>
                        ...
                        <div class="vstack gap-3">
                            <div class="d-flex justify-content-between">
                                ...
                                <span
                                    class="text-body font-monospace">{{ $customerPayment->payment_date->format('Y-m-d') }}</span>
                            </div>
                            <div class="d-flex justify-content-between">
                                <span class="text-gray-400">{{ __('Payment Method') }}</span>
                                <span class="text-body">{{ $customerPayment->payment_method }}</span>
                            </div>
                            <div class="d-flex justify-content-between">
                                <span class="text-gray-400">الرقم المرجعي</span>
                                <span
                                    class="text-body font-monospace">{{ $customerPayment->reference_number ?? '-' }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 ps-md-5">
                        ...
                        <div class="bg-success/5 border border-success/10 rounded-4 p-4 text-center mb-4">
                            <small class="text-success-300 text-uppercase letter-spacing-2 d-block mb-1">المبلغ
                                الإجمالي</small>
                            <h1 class="display-5 fw-bold text-heading text-glow mb-0">
                        ...
                        <div class="bg-surface/5 rounded-3 p-3 text-gray-300 small">
            ...
            <div class="bg-gray-900/50 p-3 border-top border-secondary border-opacity-10/10 d-flex justify-content-between text-gray-500 x-small">
                <div>
