            ...
            <div class="col-lg-8">
                ...
                <div class="text-center mb-5">
                    <div
                        ...
                        <i class="bi bi-building-fill-add fs-2 text-body"></i>
                    </div>
                    <h3 class="fw-bold text-heading tracking-wide">إضافة مستودع جديد</h3>
                    <p class="text-secondary">تجهيز نقطة تخزين جديدة للنظام</p>
                </div>
                ...
                <div class="glass-panel p-5 position-relative overflow-hidden">
                    ...
                    <form action="{{ route('warehouses.store') }}" method="POST">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="code"
                                        class="form-control form-control border-start-0 ps-0 text-body placeholder-gray-600 focus-ring-purple font-monospace"
                            ...
                            <div class="col-md-12">
                                <label
                                    class="form-label text-purple-400 small fw-bold text-uppercase tracking-wider ps-1">{{ __('Address') }}</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-surface-secondary-input border-end-0 text-gray-500"><i
