        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="text-center mb-5">
                    ...
                    <h3 class="fw-bold text-heading tracking-wide">{{ __('Edit Expense Category') }}</h3>
                    <p class="text-secondary">تحديث بيانات: <span class="text-amber-400 fw-bold">{{ $category->name }}</span>
                    </p>
                </div>
                ...
                <div class="glass-panel p-5 position-relative overflow-hidden">
                    ...
                    <form action="{{ route('categories.update', $category) }}" method="POST">
                        ...
                        <div class="mb-5">
                            <label
                                class="form-label text-amber-400 small fw-bold text-uppercase tracking-wider ps-1">{{ __('Description') }}</label>
                            <textarea name="description"
                                class="form-control form-control text-body placeholder-gray-600 focus-ring-amber"
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-4 border-top border-secondary border-opacity-10-10">
                            <a href="{{ route('categories.index') }}"
                                ...
                                <i class="bi bi-x-lg"></i>{{ __('Cancel') }}</a>
                            <button type="submit"
