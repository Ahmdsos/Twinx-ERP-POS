...
@section('title', 'استيراد الموردين - Twinx ERP')
@section('page-title', 'استيراد الموردين من CSV')
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="bi bi-upload me-2"></i>استيراد الموردين من ملف CSV</h5>
                </div>
                <div class="card-body">
                    <div class="alert alert-info">
                        <h6><i class="bi bi-info-circle me-2"></i>تعليمات الاستيراد:</h6>
                        <ul class="mb-0">
                            <li>الأعمدة المطلوبة: <strong>code</strong>, <strong>name</strong></li>
                            <li>الأعمدة الاختيارية: email, phone, address, tax_number, contact_person, payment_terms</li>
                            <li>إذا كان الكود موجود، سيتم تحديث المورد</li>
                        </ul>
                    </div>

                    <div class="mb-4">
                        <a href="{{ route('suppliers.import.sample') }}" class="btn btn-outline-primary">
